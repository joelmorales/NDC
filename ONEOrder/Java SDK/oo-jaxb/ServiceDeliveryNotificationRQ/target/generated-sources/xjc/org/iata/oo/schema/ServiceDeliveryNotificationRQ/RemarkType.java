...
@XmlSeeAlso({
    org.iata.oo.schema.ServiceDeliveryNotificationRQ.PenaltyType.ApplicableFeeRemarks.class,
    org.iata.oo.schema.ServiceDeliveryNotificationRQ.PenaltyType.Detail.Amount.ApplicableFeeRemarks.class
})
public class RemarkType {

    @XmlElement(name = "Remark", required = true)
    protected List<org.iata.oo.schema.ServiceDeliveryNotificationRQ.Remark> remark;
     ...
     * {@link org.iata.oo.schema.ServiceDeliveryNotificationRQ.Remark }
     * 
     * 
     */
    public List<org.iata.oo.schema.ServiceDeliveryNotificationRQ.Remark> getRemark() {
        if (remark == null) {
            remark = new ArrayList<org.iata.oo.schema.ServiceDeliveryNotificationRQ.Remark>();
        }
        return this.remark;
    }
