...
@XmlSeeAlso({
    org.iata.oo.schema.OrderSaleInformationNotificationRQ.PenaltyType.ApplicableFeeRemarks.class,
    org.iata.oo.schema.OrderSaleInformationNotificationRQ.PenaltyType.Detail.Amount.ApplicableFeeRemarks.class
})
public class RemarkType {

    @XmlElement(name = "Remark", required = true)
    protected List<org.iata.oo.schema.OrderSaleInformationNotificationRQ.Remark> remark;
     ...
     * {@link org.iata.oo.schema.OrderSaleInformationNotificationRQ.Remark }
     * 
     * 
     */
    public List<org.iata.oo.schema.OrderSaleInformationNotificationRQ.Remark> getRemark() {
        if (remark == null) {
            remark = new ArrayList<org.iata.oo.schema.OrderSaleInformationNotificationRQ.Remark>();
        }
        return this.remark;
    }
