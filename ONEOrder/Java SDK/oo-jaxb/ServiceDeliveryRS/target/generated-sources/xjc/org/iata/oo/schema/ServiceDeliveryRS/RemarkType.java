...
@XmlSeeAlso({
    org.iata.oo.schema.ServiceDeliveryRS.PenaltyType.ApplicableFeeRemarks.class,
    org.iata.oo.schema.ServiceDeliveryRS.PenaltyType.Detail.Amount.ApplicableFeeRemarks.class
})
public class RemarkType {

    @XmlElement(name = "Remark", required = true)
    protected List<org.iata.oo.schema.ServiceDeliveryRS.Remark> remark;
     ...
     * {@link org.iata.oo.schema.ServiceDeliveryRS.Remark }
     * 
     * 
     */
    public List<org.iata.oo.schema.ServiceDeliveryRS.Remark> getRemark() {
        if (remark == null) {
            remark = new ArrayList<org.iata.oo.schema.ServiceDeliveryRS.Remark>();
        }
        return this.remark;
    }
